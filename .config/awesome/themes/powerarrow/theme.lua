...
theme.taglist_fg_focus                          = "#98971a"--zmienić
theme.tasklist_bg_focus                         = "#282828"
theme.tasklist_fg_focus                         = "#98971a"--zmienić
...
colors2 = {}
colors2.red = "#fb4934"
colors2.green = "#b8bb26"
colors2.yellow = "#fabd2f"
colors2.blue = "#83a598"
colors2.purple = "#d3869b"
colors2.aqua = "#8ec07c"
...
local clockicon = wibox.widget.imagebox(theme.widget_clock)theme.tasklist_plain_task_name                  = true
theme.tasklist_disable_icon                     = true
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow(theme.bg_normal, colors2.aqua),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), colors2.aqua),
            arrow(colors2.aqua, colors2.blue),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), colors2.blue),
            arrow(colors2.blue, colors2.green),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), colors2.green),
            arrow(colors2.green, colors2.purple),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), colors2.purple),
            arrow(colors2.purple, colors2.red),
            wibox.container.background(wibox.container.margin(clock , dpi(4), dpi(8)), colors2.red)
            --]]
            --s.mylayoutbox
        },
    }
